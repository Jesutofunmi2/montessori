...
export const avatars: Avatar[] = [
  { id: "1", name: "Alice", color: "#A8E6CF", image: require("@/assets/images/alice.png") },
  { id: "2", name: "Bob", color: "#FFD3B6", image: require("@/assets/images/bob.png") },
  { id: "3", name: "Charlie", color: "#FFAAA5", image: require("@/assets/images/charlie.png") },
  { id: "4", name: "David", color: "#D4A5A5", image: require("@/assets/images/david.png") },
  { id: "5", name: "Eve", color: "#B5EAD7", image: require("@/assets/images/alice.png") },
  { id: "6", name: "Frank", color: "#C7CEEA", image: require("@/assets/images/frank.png") },
  { id: "7", name: "Grace", color: "#FFDAC1", image: require("@/assets/images/grace.png") },
  { id: "8", name: "Hank", color: "#F3C4FB", image: require("@/assets/images/hank.png") },
  { id: "9", name: "Bob", color: "#FFD3B6", image: require("@/assets/images/bob.png") },
  { id: "10", name: "Charlie", color: "#FFAAA5", image: require("@/assets/images/charlie.png") },
  { id: "11", name: "David", color: "#D4A5A5", image: require("@/assets/images/david.png") },
  { id: "12", name: "Eve", color: "#B5EAD7", image: require("@/assets/images/eve.png") },
  { id: "13", name: "Frank", color: "#C7CEEA", image: require("@/assets/images/frank.png") },
